...
export function payloadFromEnv(): ApplicantPayload {
  return {
    ...
    veteran_status: (() => { const v = process.env.JOBPAL_VETERAN_STATUS?.trim(); return (v && v !== "not_specified") ? v : undefined; })(),
    disability_status: (() => { const v = process.env.JOBPAL_DISABILITY_STATUS?.trim(); return (v && v !== "not_specified") ? v : undefined; })(),
