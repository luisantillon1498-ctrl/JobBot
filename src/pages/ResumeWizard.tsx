...
.name{text-align:center;font-size:11pt;font-weight:bold;text-transform:uppercase;letter-spacing:.04em;margin-bottom:1pt}
.cl{text-align:center;font-size:10.5pt;margin-bottom:0}
/* Two-column rows */
...
.role{font-weight:bold;font-size:10.5pt;margin-top:0}
.sub{font-size:10.5pt;margin-top:0}
/* Inline sections (community / skills / personal) */
.inline p{font-size:10.5pt;line-height:1.2;margin-bottom:1pt}
/* Bullets */
ul{margin:1pt 0 0 13pt}
ul li{font-size:10.5pt;line-height:1.2;margin-bottom:0;list-style-type:disc}
